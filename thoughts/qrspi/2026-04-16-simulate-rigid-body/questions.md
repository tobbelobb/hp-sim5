...
## Context
Focus on the 3D scene-loading path, ECS components, and physics systems that define body state, cable constraints, and rigid groups. Trace how authored USD scene data becomes runtime entities and how positional, rotational, and velocity updates flow across a simulation step.
...
4. How do `XPBDConstraintSystem`, `RigidGroupSystem`, and `PBDCableConstraintSolver` interact within the registered system order, and what correction ordering, iteration structure, or state handoff could explain amplified impulses or energy injection across grouped members?
