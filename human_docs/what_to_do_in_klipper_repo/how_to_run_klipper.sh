...
~/repos/hp-sim5/public/klipper/slideprinter/klipper_linux_mcu_bridge.py --raw-path /tmp/klipper_host_mcu_raw --host-path /tmp/klipper_host_mcu --mcu-bin ~/repos/hp-sim5/public/klipper/linux_mcu/klipper.elf --dict ~/repos/hp-sim5/public/klipper/linux_mcu/klipper.dict --klipper-py ~/repos/hp-sim5/klipper/klippy/

# Then launch klippy with

.venv/bin/python ~/repos/hp-sim5/klipper/klippy/klippy.py ~/repos/hp-sim5/public/klipper/slideprinter/printer-slideprinter-linux-mcu.cfg -i ~/repos/hp-sim5/public/gcode/movements.gcode -v -l ~/repos/hp-sim5/attic/klipper.log
...
# cp out klipper.dict ../hp-sim5/public/klipper/avr/klipper.dict
# cp out klipper.elf ../hp-sim5/public/klipper/avr/klipper.elf
...
PYTHONPATH=~/repos/simulavr/build/pysimulavr ~/repos/hp-sim5/public/klipper/slideprinter/klipper_avr_bridge.py ~/repos/hp-sim5/public/klipper/avr/klipper.elf --dict ~/repos/hp-sim5/public/klipper/avr/klipper.dict --klipper-py ~/repos/hp-sim5/klipper/klippy/ --rate 1.0 --keep-noise --parse-debug
...
.venv/bin/python ~/repos/hp-sim5/klipper/klippy/klippy.py ~/repos/hp-sim5/public/klipper/slideprinter/printer-slideprinter-avr.cfg -i ~/repos/hp-sim5/public/gcode/draw_squares.gcode -v -l ~/repos/hp-sim5/attic/klipper.log
