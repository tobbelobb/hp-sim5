...
.venv/bin/python ./klippy/klippy.py ~/repos/hp-sim5/public/klipper/slideprinter/printer-slideprinter-avr.cfg  -i /home/torbjorn/repos/hp-sim5/public/gcode/draw_squares.gcode  -o test.serial -v -d out/klipper.dict
