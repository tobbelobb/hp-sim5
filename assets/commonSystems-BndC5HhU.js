var q=Object.defineProperty;var D=(a,e,i)=>e in a?q(a,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):a[e]=i;var g=(a,e,i)=>D(a,typeof e!="symbol"?e+"":e,i);import{b as $,G as N,a as b,O as P,A as I,x as A,w as k,M as R,e as V,N as j,V as W}from"./renderSystem-Cwv3zWAf.js";function z(a){const e=a.systems.find(c=>c.constructor.name==="RenderSystem"),i=e?e.viewScaleMultiplier:1,m=e?e.viewOffsetX_sim:0,r=e?e.viewOffsetY_sim:0;let s=`
...
`,s}class J{constructor(){g(this,"runInPause",!1)}update(e,i){const m=e.query([P,k]);for(const r of m){const s=e.getComponent(r,P),o=e.getComponent(r,k);o.angle=s.angle}}}class Y{constructor(){g(this,"runInPause",!1)}_normalizeAngle(e){for(;e>Math.PI;)e-=2*Math.PI;for(;e<-Math.PI;)e+=2*Math.PI;return e}update(e,i){const m=e.getResource("grabbedBall"),r=e.query([P,I,k,V]);if(!(i<=1e-9))for(const o of r){if(o===m)continue;const l=e.getComponent(o,V);if(l&&l.invInertia<=0)continue;const u=e.getComponent(o,P),c=e.getComponent(o,I),p=e.getComponent(o,k),f=u.angle,C=p.angle;let t=this._normalizeAngle(f-C);c.angularVelocity=t/i}}}class H{constructor(){g(this,"runInPause",!1)}update(e,i){const m=e.getResource("grabbedBall"),r=e.query([b,$,A,R]);if(!(i<=1e-9))for(const o of r){if(o===m)continue;const l=e.getComponent(o,R);if(l&&l.mass<=0)continue;const u=e.getComponent(o,b),c=e.getComponent(o,$),p=e.getComponent(o,A);c.vel.subtractVectors(u.pos,p.pos).scale(1/i)}}}class K{constructor(){g(this,"runInPause",!1)}update(e,i){const m=e.getResource("grabbedBall"),r=e.getResource("gravity");if(!r)return;const s=e.query([$,N]);for(const o of s){if(o===m)continue;e.getComponent(o,$).vel.add(r,i)}}}class Q{constructor(){g(this,"runInPause",!1)}update(e,i){const m=e.query([j]),r=1e-9;for(const s of m){const o=e.getComponent(s,j),l=o.entityA,u=o.entityB,c=e.getComponent(l,b),p=e.getComponent(u,b);if(!c||!p)continue;const f=c.pos,C=p.pos,t=e.getComponent(l,R),n=t&&t.mass>0?1/t.mass:0,d=e.getComponent(l,V),y=d?d.invInertia:0,h=e.getComponent(u,R),v=h&&h.mass>0?1/h.mass:0,S=e.getComponent(u,V),T=S?S.invInertia:0;if(n+v+y+T<=r)continue;const O=new W().subtractVectors(C,f),B=O.length();if(B<=r)continue;const x=O.clone().scale(1/B),G=B-o.restLength,_=o.compliance/(i*i),F=n+v+_;if(F<=r)continue;const M=(-G-_*o.lambda)/F;o.lambda+=M;const E=x.clone().scale(M);if(n>0){const w=E.clone().scale(-n);f.add(w),e.getComponent(l,$)}if(v>0){const w=E.clone().scale(v);C.add(w),e.getComponent(u,$)}}}}class Z{constructor(){g(this,"runInPause",!1)}update(e,i){const m=e.getResource("grabbedBall"),r=e.query([b,$]);for(const s of r){if(s===m)continue;const o=e.getComponent(s,b),l=e.getComponent(s,$);o.pos.add(l.vel,i)}}}class ee{constructor(){g(this,"runInPause",!1)}update(e,i){const m=e.query([b,A]);for(const r of m){const s=e.getComponent(r,b);e.getComponent(r,A).pos.set(s.pos)}}}class te{constructor(){g(this,"runInPause",!1)}update(e,i){const m=e.query([P,I]);for(const r of m){const s=e.getComponent(r,P),o=e.getComponent(r,I);s.angle+=o.angularVelocity*i}}}export{te as A,K as G,Z as M,ee as P,Q as X,J as a,H as b,Y as c,z as d};
