...
# Usage: ./run_logo_slideprinter_determinism_test.sh [iterations]
ITERATIONS="${1:-10}"
...
BASE_LOG="$VSD_DIR/logs/Hangprinter_logo6_slideprinter.csv"
TEST_LOG="$VSD_DIR/logs/Hangprinter_logo6_slideprinter_2.csv"
...
for ((i=1; i<=ITERATIONS; i++)); do
    if ! "$BUILD_DIR/rrf_simulator" \
        ...
        --can-log logs/Hangprinter_logo6_slideprinter_2.csv \
