...
/*static*/ uint32_t MessageBox::Create(const char* _ecv_array msg,
                                       const char* _ecv_array title, int mode,
                                       float timeout, AxesBitmap controls,
...
/*static*/ bool MessageBox::Acknowledge(uint32_t, bool& wasBlocking,
...
void MessageBoxLimits::GetIntegerLimits(GCodeBuffer&, bool defaultIsString)
