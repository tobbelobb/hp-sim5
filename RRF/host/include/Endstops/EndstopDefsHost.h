...
// This prevents redefinition errors from the real
// RRF/ReprapFirmware/src/Endstops/EndstopDefs.h
...
struct EndstopHitDetails
{
    ...
    EndstopHitAction GetAction() const noexcept
    {
        return action;
    }
    float GetZProbeHeightError() const noexcept
    {
        return 0.0f;
    }
    bool HasDriver() const noexcept
    {
        return false;
    }
};
