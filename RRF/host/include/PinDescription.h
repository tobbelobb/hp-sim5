...
{
	return static_cast<PinCapability>(static_cast<uint8_t>(lhs) | static_cast<uint8_t>(rhs));
}
...
inline constexpr bool HasCapability(PinCapability value, PinCapability capability) noexcept
{
