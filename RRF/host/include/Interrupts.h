...
inline bool AttachPinInterrupt(Pin, StandardCallbackFunction, InterruptMode,
                               CallbackParameter, bool = true) noexcept
{
    return false;
}
...
inline ExintNumber AttachEvent(Pin, InterruptMode, bool) noexcept
{
    return 0;
}
...
inline bool ReadDebouncedPin(Pin) noexcept
{
    return false;
}
