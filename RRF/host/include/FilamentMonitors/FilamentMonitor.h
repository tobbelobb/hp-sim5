...
public:
    ...
    static bool CheckDriveAssignments(const StringRef&) noexcept
    {
        return false;
    }
    ...
    static FilamentMonitor* GetMonitorAlreadyLocked(size_t) noexcept
    {
        return nullptr;
    }

#if SUPPORT_REMOTE_COMMANDS
    static GCodeResult Create(const CanMessageCreateFilamentMonitor&,
                              const StringRef&) noexcept
    {
        return GCodeResult::warningNotSupported;
    }

    static GCodeResult Delete(const CanMessageDeleteFilamentMonitor&,
                              const StringRef&) noexcept
    {
        return GCodeResult::warningNotSupported;
    }
