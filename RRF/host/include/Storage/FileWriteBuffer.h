...
public:
	...
	size_t BytesStored() const noexcept { return index; }
	size_t BytesLeft() const noexcept { return HostStorage::FileWriteBufLen - index; }
	...
	void DataTaken() noexcept { index = 0; }
	void DataStored(size_t numBytes) noexcept { index += numBytes; }
