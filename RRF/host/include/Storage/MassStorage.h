...
bool CombineName(const StringRef& outbuf, const char* directory,
...
bool Delete(const StringRef& filePath, ErrorMessageMode errorMessageMode,
...
GCodeResult GetFileInfo(const char* filePath, GCodeFileInfo& info, bool quitEarly,
                        GlobalVariables* customVars) noexcept;
...
bool Rename(const char* oldFilePath, const char* newFilePath, bool deleteExisting,
            bool messageIfFailed) noexcept;
...
GCodeResult ConfigureSdCard(GCodeBuffer& gb, const StringRef& reply)
