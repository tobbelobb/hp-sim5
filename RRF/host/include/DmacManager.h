...
namespace DmacManager
{
	...
	inline uint16_t GetBytesTransferred(DmaChannel) noexcept { return 0; }
	inline void EnableChannel(DmaChannel, DmaPriority) noexcept {}
	inline bool DisableChannel(DmaChannel) noexcept { return true; }
	inline bool SuspendChannel(DmaChannel) noexcept { return true; }
	inline void ResumeChannel(DmaChannel) noexcept {}
	inline void SetInterruptCallback(DmaChannel, DmaCallbackFunction, CallbackParameter) noexcept {}
