...
; Kinematics
M584 X40.0 Y41.0 Z42.0 U43.0 V44.0 W45.0 A46.0 B47.0 E48.0 P8 ; map ABCDIJLOE-axes to CAN addresses, and set eight visible axes.
M669 K6                         ; "This is a Hangprinter"
M669 N8                         ; This Hangprinter has eight anchors
M666 A3                         ; anchorMode=HangprinterAnchorMode::HalfTop, // 0=None, 1=last-top, 2=all-top, 3-half-top, etc
M669 S130 T0.5                  ; Segments per second and min segment length

; Anchor Location
M669 A1284.9:-1284.9:1900.0 B1284.9:1284.9:1900.0 C-1284.9:1284.9:1900.0 D-1284.9:-1284.9:1900.0 I1284.9:-1284.9:-280.0 J1284.9:1284.9:-280.0 L-1284.9:1284.9:-280.0 O-1284.9:-1284.9:-280.0
M666 Q0.6366197723675814 R39.1845:39.1845:39.1845:39.1845:39.1845:39.1845:39.1845:39.1845
; Explanation:
...
M666 U1:1:1:1:1:1:1:1     ; Mechanical advantages
M666 O1:1:1:1:1:1:1:1     ; Number of lines per spool
M666 L20:20:20:20:20:20:20:20  ; Motor gear teeth
M666 H20:20:20:20:20:20:20:20  ; Spool gear teeth

; Flex compensation
M666 W0.216                                             ; Mover weighs X kg.
...
M666 I10.0:10.0:10.0:10.0:10.0:10.0:10.0:10.0           ; Min planned force in all directions (unit N).
M666 X170.0:170.0:170.0:170.0:170.0:170.0:170.0:170.0   ; Max planned force in all directions (unit N)
...
M666 Y117.2:117.2:117.2:117.2:117.2:117.2:117.2:117.2
...
; Drives
M666 J200:200:200:200:200:200:200:200 ; Full steps per ABC motor revolution
...
M569 P5 S1 ; Drive 6 goes forwards
M569 P5 S1 ; Drive 7 goes forwards
M569 P5 S1 ; Drive 8 goes forwards

M569 P40.0 S1 ; Drive 40.0 (A) goes forwards
M569 P41.0 S1 ; Drive 41.0 (B) goes forwards
M569 P42.0 S1 ; Drive 42.0 (C) goes forwards
M569 P43.0 S1 ; Drive 43.0 (D) goes forwards
M569 P44.0 S1 ; Drive 44.0 (I) goes forwards
M569 P45.0 S1 ; Drive 45.0 (J) goes forwards
M569 P46.0 S1 ; Drive 46.0 (L) goes forwards
M569 P47.0 S1 ; Drive 47.0 (O) goes forwards
M569 P48.0 S1 ; Drive 48.0 (E) goes forwards
