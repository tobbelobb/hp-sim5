...
describe('PBDResolveCableOverCorrections', () => {
  test('test_resolve_over_correction_pushes_apart', () => {
    ...
    const initialPosB = new Vector2(8.0, 0.0);
    ...
    world.addComponent(entityB, new OrientationComponent(0.0));
    ...
    joint1.attachmentPointB_world.set(new Vector2(11.0, 0.0)); // Stretched state
    joint2.attachmentPointA_world.set(new Vector2(11.0, 0.0));
    ...
    const finalAttachmentB = finalPosCompB.pos.clone().add(new Vector2(-1.0, 0.0));
    ...
    expect(finalOrientationCompB.angle).toBeCloseTo(0.0);
  });
