Testing an ECS architecture combined with Position Based Dynamics (PBD) requires a multi-layered approach. Here are best practices tailored to this codebase:
