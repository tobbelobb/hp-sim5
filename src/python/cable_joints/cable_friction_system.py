...
class CableFrictionSystem:
    ...
    the cable slipping over rollers or through pinholes based on tension
    and friction. This system should run after the main positional solvers
    but before the velocity updates.
    """
    def __init__(self):
